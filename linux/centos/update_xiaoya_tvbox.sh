BASE_DIR=/root/workspace/xiaoya-tvbox
PORT1=4567
PORT2=5344
PORT3=5345
TAG="latest"
...
config_dir=/root/workspace/docker/xiaoya
...
usage(){
  ...
  echo "-d BASE_DIR    数据目录，默认：/root/workspace/xiaoya-tvbox"
